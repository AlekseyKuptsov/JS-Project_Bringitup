...
/* harmony import */ var _modules_slider_sliderV2__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/slider/sliderV2 */ "./src/js/modules/slider/sliderV2.js");
/* harmony import */ var _modules_playVideo__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/playVideo */ "./src/js/modules/playVideo.js");
/* harmony import */ var _modules_slider_slider_min__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/slider/slider-min */ "./src/js/modules/slider/slider-min.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var showUpSlider = new _modules_slider_slider_min__WEBPACK_IMPORTED_MODULE_3__["default"]({
  ...
  showUpSlider.init();
  var modulesSlider = new _modules_slider_slider_min__WEBPACK_IMPORTED_MODULE_3__["default"]({
  ...
  modulesSlider.init();
  var feedSlider = new _modules_slider_slider_min__WEBPACK_IMPORTED_MODULE_3__["default"]({
  ...
  var oldOfficer = new _modules_difference__WEBPACK_IMPORTED_MODULE_4__["default"]('.officerold', '.officer__card-item');
  oldOfficer.init();
  var newOfficer = new _modules_difference__WEBPACK_IMPORTED_MODULE_4__["default"]('.officernew', '.officer__card-item');
  newOfficer.init();
  var form = new _modules_form__WEBPACK_IMPORTED_MODULE_5__["default"]('.form');
  form.init();
  new _modules_showInfo__WEBPACK_IMPORTED_MODULE_6__["default"]('.module__info-show .plus').init();
    ...
    value: function bindTriggers() {
      ...
      this.officer.querySelector('.plus').addEventListener('click', function () {
        if (_this.counter < _this.items.length - 2) {
          ...
          _this.items[_this.counter].classList.add('fadeInDown');
          ...
          _this.items[_this.items.length - 1].style.display = 'none';
        }
      });
    }
  }, {
...
function () {
  function Form(form) {
    ...
    this.message = {
      ...
      failure: 'Something is gone wrong...'
    };
  ...
  _createClass(VideoPlayer, [{
    ...
    value: function onPlayerStateChange(state) {
      try {
        ...
        var playBtnIcon = this.activeBtn.querySelector('svg').cloneNode(true);
...
function (_Slider) {
  ...
  function MainSlider(btns, modulePrev, moduleNext) {
    _classCallCheck(this, MainSlider);

    return _possibleConstructorReturn(this, _getPrototypeOf(MainSlider).call(this, btns, modulePrev, moduleNext));
  }
...
function (_Slider) {
  ...
  _createClass(MiniSlider, [{
    ...
    key: "animation",
    value: function animation(autoplay) {
      var _this4 = this;
      ...
      if (autoplay) {
        ...
        [this.container, this.prev, this.next].forEach(function (item) {
          item.addEventListener('mouseleave', function () {
            _this4.paused = setInterval(function () {
              return _this4.nextSlide();
            }, 5000);
          });
        });
...
/***/ "./src/js/modules/slider/sliderV2.js":
/*!*******************************************!*\
  !*** ./src/js/modules/slider/sliderV2.js ***!
  \*******************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return SliderV2; });
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0__);
...
/*#__PURE__*/
function () {
  function SliderV2(page, btn) {
    _classCallCheck(this, SliderV2);
  ...
  _createClass(SliderV2, [{
    ...
    value: function showSlides(n) {
      ...
      this.page.style.transform = "translateY(-".concat(n * this.offset, "px)");
    }
  }, {
    key: "render",
    value: function render() {
